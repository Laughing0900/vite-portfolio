...
export function LoadingCarousel({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "mx-auto w-full max-w-6xl rounded-lg bg-muted shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)]",
                className
            )}
        >
            <div className="w-full overflow-hidden rounded-lg">
                                        ...
                                        {backgroundTips ? (
                                            ...
                                            >
                                                {displayTips[current]?.url ? (
                                                    ...
                                                    >
                                                        <p className="text-center text-base font-medium leading-relaxed tracking-tight text-white sm:text-lg md:text-left md:text-xl lg:text-2xl lg:font-bold">
                                                            {tip.text}
                                                        </p>
                                                    </a>
                                                ) : (
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center space-x-2 whitespace-nowrap text-primary">
                            {backgroundTips ? (
                    ...
                    {showProgress && (
                        <motion.div
                            ...
                            className="mt-2 h-1 origin-left bg-muted"
                        />
                    )}
                </div>
            </div>
